    ...
    <div class="row align-items-center">
      <div class="col-lg-6">
        ...
        <div class="d-flex justify-content-start mb-4">
          <a class="btn btn-primary" href="https://www.microfocus.com/es-es/products/information-data-analytics-idol/contact" target="_self" rel="noopener">Contacto</a>
        </div>
      </div>
      <div class="col-lg-6">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 mb-4">
        ...
        <img class="img-fluid" src="https://pnx-assets-prod.s3.amazonaws.com/2023-05/feature-small-12x_35_0.webp" alt="Detección y reconocimiento de logotipos">
      </div>
      <div class="col-lg-6 mb-4">
        <div class="bg-white p-4">
